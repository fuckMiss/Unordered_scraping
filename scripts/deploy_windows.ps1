...
$WeightsTargetDir = Join-Path $TargetDir "models\DG_8_weights"
New-Item -ItemType Directory -Force -Path $WeightsTargetDir | Out-Null
Copy-IfExists (Join-Path $AppDir "models\DG_8_weights\best_obb.xml") $WeightsTargetDir
Copy-IfExists (Join-Path $AppDir "models\DG_8_weights\best_obb.bin") $WeightsTargetDir
Copy-IfExists (Join-Path $AppDir "models\DG_8_weights\best_seg.xml") $WeightsTargetDir
Copy-IfExists (Join-Path $AppDir "models\DG_8_weights\best_seg.bin") $WeightsTargetDir

...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("models/DG_8_weights"),
    ...
    parser.add_argument(
        ...
        choices=("fp32", "fp16"),
        default="fp32",
        help="OpenVINO export precision. Default fp32 keeps confidence closer to PT; fp16 is smaller/faster.",
    )
...
def main() -> int:
    ...
    export_half = args.precision == "fp16"

...
bool GraspMainWindow::applySavedEngineeringSettings(const EngineeringSettingsDraft& draft,
                                                    ...
                                                    QString* error_message)
{
    ...
    const ProjectProfileSettings next_profile = projectProfileSettingsFromDraft(
        draft,
        trimmed_profile_name);
    if (!validateProjectProfileModels(next_profile, error_message)) {
        return false;
    }

    pending_engineering_profile_settings_ = next_profile;

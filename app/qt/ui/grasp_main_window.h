...
private:
    ...
    enum class PendingStartAction {
        None,
        ImageDetection,
        PlcGrasp
    };

    enum class PendingActivationResult {
        Ready,
        Loading,
        Failed
    };
    ...
    bool setAdminCredentials(const QString& username,
    ...
    void loadProjectProfileSettings();
    bool saveProjectProfileSettings(QString* error_message = nullptr) const;
    ProjectProfileSettings currentProjectProfileSettings(const QString& profile_name) const;
    ProjectProfileSettings projectProfileSettingsFromDraft(const EngineeringSettingsDraft& draft,
                                                            const QString& profile_name) const;
    ProjectProfileSettings legacyProjectProfileDefaults() const;
    void applyProjectProfileSettings(const ProjectProfileSettings& profile);
    ...
    PendingActivationResult activatePendingEngineeringSettingsForStart(
        ...
        QString* error_message = nullptr);
    void finishPendingEngineeringSettingsActivation(bool success,
                                                    const QString& error_message,
                                                    PendingStartAction action);
    bool validateProjectProfileModels(const ProjectProfileSettings& profile,
                                      QString* error_message) const;
    void stopRuntimeForProjectProfileSwitch();
    ...
    QComboBox* project_profile_selector_ = nullptr;
    ...
    QString current_project_profile_name_;
    QString active_project_profile_name_;
    QString pending_project_profile_name_;
    ProjectProfileSettings pending_previous_project_profile_settings_;
    bool has_pending_previous_project_profile_settings_ = false;
    ProjectProfileSettings pending_engineering_profile_settings_;
    QString pending_engineering_profile_name_;
    ProjectProfileSettings pending_activation_previous_profile_settings_;
    bool has_pending_engineering_profile_settings_ = false;
    bool has_pending_activation_previous_profile_settings_ = false;
    PendingStartAction pending_start_action_ = PendingStartAction::None;
    QString camera_ip_;
    ...
    bool show_head_type_adjusted_geometry_ = true;
